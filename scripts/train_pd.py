...
data, provenance = load_data(); model, metrics = train_pd(data); challenger, challenger_metrics = train_challenger(data)
...
joblib.dump(challenger, "artifacts/pd_xgboost.joblib")
